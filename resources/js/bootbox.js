...
var editor_config = {
    ...
    setup: function (ed) {
        ed.on('init', function (e) {
            ...
            ed.execCommand("fontSize", false, "15px");
            if($('textarea.tinymce').html().length < 3){
                //ed.setContent('Start met typen of plak jouw tekst in dit venster..');
            }
            $('.mce-tinymce').trigger('done');
        });
        ...
        ed.on('keyup', function () {
            ...
            if(typeof id != 'undefined'){
                $('#'+id+'.tinymce').trigger('change').val(content);
            }else{
                $('textarea.tinymce').trigger('change').val(content);
            }
        });
    }
};
...
(function (root, factory) {
  ...
  var templates = {
    ...
    inputs: {
      number:
        "<input step=0.1 class='bootbox-input bootbox-input-number form-control' autocomplete=off type=number />",
      date:
      ...
      tinymce:
        "<textarea class='bootbox-input bootbox-input-textarea form-control tinymce'></textarea>",
      email:
        "<input class='bootbox-input bootbox-input-email form-control' autocomplete='off' type='email' />",
      select:
        "<select class='bootbox-input bootbox-input-select form-control'></select>",
      multiselect:
          "<select class='bootbox-input bootbox-input-select form-control' multiple='multiple'></select>",
      checkbox:
      ...
      switch (opts.type) {
        ...
        case "multiselect":
          ...
          each(inputOptions, function(_, option) {
            ...
            elem.append("<option value='" + option.value + "' "+ (option.selected ? 'selected=selected' : '') +">" + option.text + "</option>");
          });
  ...
  exports.dialog = function(options) {
    ...
    if (options.description) {
      body.find(".bootbox-body").prepend(options.description+'<br>');
    }
